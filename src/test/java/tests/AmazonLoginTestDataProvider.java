...
public class AmazonLoginTestDataProvider
{
	...
	public Object[][] testData()
	{
		...
		{
			{"","blank","Gatturohan@134","valid"},
			{"gatturohan","invalid_emailid","Gatturohan@134","valid"},
			{"9030","invalid_mbno","Gatturohan@134","valid"},
			{"9030957386","valid","","blank"},
			{"9030957386","valid","atturohan","invalid"},
			{"9030957386","valid","Gatturohan@134","valid"}
		};
		return(data);
	}
